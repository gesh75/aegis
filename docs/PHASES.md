...
override): `docs/DEVELOPER.md` §7. Detect the pairing hole with
`GET /api/status` (`api_auth=open` + `approve_hmac=required`). OSCAL/CAB
field contract: `docs/EVIDENCE.md` §§4–5.
